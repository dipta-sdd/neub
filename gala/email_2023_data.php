...
//  $email='chandudyryf@gmail.com';
 ...
 $sql="select * from email3 where email='" . $email . "'";
 $data ="";
...
$data='<form id="form_email_2023" class="float-start shadow-lg ms-auto me-auto mb-5 g-1 p-3 bg-body col-md-10 rounded text-start">
...
$data.='<div class="form-check ms-3">
        ...
        <div class="col-12 text-end">
          <button type="Update" id="btn_email_2023_update" class="btn btn-primary">Update</button>
        </div>
      </div>
      </form>
      ...
      <script>
      $("#btn_email_2023_update").click(function( e){
      e.preventDefault();
      $.ajax({
        type: "POST",
        url: "./email_2023_data_update.php",
        data:  {
          "eth": $("#eth").val(),
          "pc": $("#pc").val(),
