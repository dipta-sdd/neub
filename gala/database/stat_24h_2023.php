<?php
    ...
    while($row = $result->fetch_assoc()) {
        $data.='<div class="progress m-2"><div class=" progress-bar bg-primary" role="progressbar" style="width: '.($row['score'] ) .'%;"aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">'. $row['player'].' '. $row['score'] .'</div></div>';
    }
