<?php
    ...
    if($discord_conn==='true'){
        $sql="UPDATE `email2023` SET `discord`='".$discord."',`dis_pl`='".$user."',`eth`='".$eth."',`other`='".$other."', `gala`='".$gala."' WHERE `email`='".$email."'";
    }else{
        $sql="UPDATE `email2023` SET `discord`='".$discord."',`eth`='".$eth."',`other`='".$other."', `gala`='".$gala."' WHERE `email`='".$email."'";
    }
    // echo $sql;
